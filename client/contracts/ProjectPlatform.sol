...
contract ProjectPlatform is ERC721URIStorage {
    constructor() ERC721("ProjectPlatform", "PPLTFM") {
    ...
    Counters.Counter private _projectsRegistered;
   ...
   //The first time a token is created, it is listed here
    ...
    function getAllNFTs() public view returns (ListedToken[] memory) {
        ...
        {
            uint currentId = i + 1;
            // if(idToListedToken[currentId].notSpam){
    ...
    function markSpam(uint256 tokenId) private {
        if(address(this) == admin){
            idToListedToken[tokenId].notSpam = false;
